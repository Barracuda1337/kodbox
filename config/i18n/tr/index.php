...
<li> IP aralığı: ip, aralık dahilinde eşleşir; örneğin: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.shareToMeList"    => "Izgara görünümü",
    ...
    "admin.member.spaceTipsFull"     => "Sınırlandırılmamış",
    "admin.member.spaceSize"         => "Bulut boyutu",
    "admin.member.spaceSizeUse"      => "Bulut kullanımı",
...
<li> Güncelleme: İndirdikten sonra, ilgili eklenti adı klasörüne yükleyin ve açın;</li>",
    ...
    "admin.backup.notStart"          => "Başlatılmadı",
    ...
    "admin.share.rptUser"            => "Bilgi veren",
 ...
 post_max_size, yeniden başlatmanız gerekiyor)",
    ...
    "common.test"                    => "test",
    "common.absolutePath"            => "Tam adres",
    "common.qrcode"                  => "QR kodu",
    ...
    "common.title"                   => "Başlık",
    "common.time"                    => "Zaman",
    "common.scan"                    => "Görüntüleme",
    "common.report"                  => "Bildiri",
    "common.name"                    => "Ad",
    "common.nickName"                => "Takma Ad",
    "common.tools"                   => "Araçlar",
    "common.tag"                     => "Etiketler",
    "common.position"                => "Konumlar",
    "common.mount"                   => "Ağ Konumu",
    "common.type"                    => "Dosya Türü",
    "common.auth"                    => "yetki",
    "common.status"                  => "durum",
    "common.run"                     => "çalıştır",
    "common.file"                    => "dosya",
    ...
    "common.tips"                    => "ipuçları",
    "common.desc"                    => "açıklama",
    ...
    "common.unzip"                   => "çıkartma",
    "common.preview"                 => "Önizleme",
    "common.share"                   => "Paylaş",
    "common.search"                  => "Ara",
    "common.query"                   => "Sorgu",
    "common.delete"                  => "Sil",
    "common.deleteForce"             => "Direk Sil",
    ...
    "common.createTime"              => "Oluşturma zamanı",
    ...
    "explorer.recycleClear"          => "Geri Dönüşüm Kutusunu Temizle",
    "explorer.recycleClearForce"     => "Geri dönüşüm kutusunda çok fazla içerik var, lütfen önce geri dönüşüm kutusunu temizleyin!",
    "explorer.recycleRestore"        => "Geri Dönüşüm Kutusu'nu Geri Yükle",
    "explorer.recycleRestoreItem"    => "Geri Yükle",
    "explorer.recycleRestoreAll"     => "Tümünü geri yükle",
    "explorer.recycleClearInfo"      => "Geri dönüşüm kutusunu tamamen temizlemek istediğinizden emin misiniz?",
    ...
    "explorer.usersShare"            => "Kullanıcısı Paylaştı",
    "explorer.clipboard"             => "Kopyalama Panosu",
    "explorer.clipboardClear"        => "Kopyalama Panosunu Temizle",
    "explorer.fullScreen"            => "Tam Ekran",
    "explorer.folderItem"            => "Öğe",
    ...
    "explorer.fileLock"              => "Kilitle",
    "explorer.fileLockNow"           => "Şimdi Kilitle",
    ...
    "explorer.saved"                 => "Kaydedildi",
    "explorer.opened"                => "Açıldıé",
    "explorer.openFail"              => "Açma başarısız!",
    "explorer.openingWithLoc"        => "Dosya açık ...",
    "explorer.openOnlyView"          => "Salt okunur açık",
    ...
    "explorer.createLinkHome"        => "Masaüstüne kısayol oluştur",
    "explorer.setBackground"         => "Masaüstü duvar kağıdı olarak ayarla",
    "explorer.favRemove"             => "Bu favoriyi kaldır",
    "explorer.openPath"              => "Konuma git",
    "explorer.openPathFinished"      => "Konuma zaten girdiniz",
    "explorer.openIE"                => "Tarayıcıda Aç",
    "explorer.newFile"               => "Yeni dosya",
    "explorer.newFolder"             => "Yeni klasör",
    "explorer.fileSaveTo"            => "Dosya kaydedildi",
    "explorer.openFather"            => "Üst klasör",
    ...
    "explorer.downReady"             => "Hazırlanıyor ...",
    "explorer.downError"             => "İndirme başarısız!",
    "explorer.max"                   => "Maksimum",
    "explorer.min"                   => "Minumum",
    ...
    "explorer.toolbar.fav"           => "Favoriler",
    "explorer.toolbar.desktop"       => "Masaüstü",
    "explorer.toolbar.client"        => "İstemci",
    "explorer.toolbar.myComputer"    => "Bilgisayarım",
    "explorer.toolbar.recycle"       => "Çöp kutusu",
    "explorer.toolbar.myDocument"    => "Dökümanlar",
    "explorer.toolbar.myPicture"     => "Fotoğraflar",
    "explorer.toolbar.myMusic"       => "Müzikler",
    "explorer.toolbar.myMovie"       => "Videolar",
    "explorer.toolbar.myDownload"    => "İndirilenler",
    ...
    "explorer.toolbar.uiLogout"      => "Çıkış",
    ...
    "explorer.toolbar.shareToMe"     => "Benimle paylaşılan",
    "explorer.toolbar.shareTo"       => "Paylaşılan",
 ...
 İlk harfin pinyin, bulanık eşleşmesini destekleyin",
    ...
    "explorer.file.name"             => "Dosya Adı",
    "explorer.file.type"             => "tür",
    "explorer.file.contain"          => "içermek",
    "explorer.file.address"          => "Dosya Konumu",
    ...
    "explorer.file.path"             => "Dosya Konumu",
    "explorer.file.action"           => "eylem",
    "explorer.file.creator"          => "Oluşturan",
    "explorer.file.editor"           => "Düzenleyen",
    "explorer.file.location"         => "Dosya Konumu",
    "explorer.file.timeInfo"         => "Zaman bilgisi",
    "explorer.file.createTime"       => "Oluşturma zamanı",
    "explorer.file.modifyTime"       => "Değişiklik zamanı",
    "explorer.file.lastTime"         => "Son ziyaret",
    "explorer.file.sortType"         => "sıralama",
    "explorer.file.sortDisable"      => "İçerik belirtilen sıralamayı desteklemiyor!",
    "explorer.file.timeType"         => "d / m / Y H: i: s",
    "explorer.file.timeTypeInfo"     => "d / m / Y H: i: s",
    "explorer.file.listType"         => "görünüm",
    "explorer.file.listIcon"         => "Simge görünümü",
    "explorer.file.listList"         => "Liste görünümü",
    "explorer.file.listListSplit"    => "Sütun görünümü",
    ...
    "explorer.file.listSortKeep"     => "Sırala",
    ...
    "explorer.file.sharer"           => "Oluşturan",
    ...
    "explorer.app.app"               => "Uygulamalar",
    "explorer.app.createLink"        => "Yeni URL",
    "explorer.app.create"            => "Uygulama Oluştur",
    "explorer.app.edit"              => "Uygulamadüzenle",
    "explorer.app.open"              => "Uygulama Aç",
    "explorer.app.groupGame"         => "Oyunlar",
    "explorer.app.groupTools"        => "Araçlar",
    "explorer.app.groupReader"       => "Okuma",
    "explorer.app.groupMovie"        => "Film",
    "explorer.app.groupMusic"        => "Müzik",
    "explorer.app.groupLife"         => "Yaşam",
    ...
    "explorer.app.openType"          => "Açma Şekli",
    "explorer.app.openWindow"        => "Yeni Sekme",
    "explorer.app.openDialog"        => "Yeni Pencere",
    "explorer.app.openCurrent"       => "geçerli sayfa",
    "explorer.app.openInline"        => "Sayfayı yerleştir",
    "explorer.app.dialogSize"        => "Pencere Boyutu",
    ...
    "explorer.table.first"           => "Anasayfa",
    "explorer.table.last"            => "Son sayfa",
    "explorer.table.prev"            => "Önceki",
    "explorer.table.next"            => "Sonraki",
    ...
    "explorer.search.sizeAll"        => "Bütün boyutlar",
    ...
    "explorer.share.openLink"        => "Bağlantı Aç",
    "explorer.share.copyLink"        => "Bağlantı Kopyala",
    ...
    "explorer.rename.mutil"          => "Toplu yeniden adlandır",
    ...
    "explorer.tag.addTo"             => "Etiket ekle",
    ...
    "explorer.panel.version"         => "sürüm",
    "explorer.panel.chat"            => "mesaj",
    "explorer.panel.log"             => "kayıt",
    ...
    "log-event-share-shareToAdd-more" => "[1] ortak paylaşımlar oluşturuldu",
    ...
    "explorer.fileInfo.pagePower"    => "İçerik oluşturucu",
